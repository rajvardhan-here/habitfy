    ...
    return (
      <div style={{ minHeight: '100vh', background: YELLOW, fontFamily: "'Inter', sans-serif", overflowY: 'auto' }}>
        ...
        <div style={{ padding: 20 }}>
          ...
          {/* HEADER */}
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: isMobile ? 'flex-start' : 'space-between', flexWrap: 'wrap', gap: 10, marginBottom: 20 }}>
            <div>
          ...
          {/* ROW 1 */}
          gridTemplateColumns: isMobile ? '1fr' : '1fr 160px 200px', gap: 14, marginBottom: 16
